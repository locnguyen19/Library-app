    ...
    bookData && <div>
      <Row gutter={[16, 16]} align="middle" justify="center">
        ...
        >
          ...
          <div justify="center"  >
            <h1 className = " text-xl text-secondary uppercase font-bold mt-3 ">SHORT DESCRIPTION</h1>
          ...
          <div className="flex justify-between">
            <h1 className="text-md">Rent per day</h1>
            <h1 className="text-md"> &euro;{bookData?.rentPerDay}</h1>
          </div>
        </Col>
      </Row>
    </div>
